...
export const GOLFERS: Record<Tier, Golfer[]> = {
  tier1: [
    { name: 'Scottie Scheffler', odds: '+350', tier: 'tier1' },
    { name: 'Rory McIlroy', odds: '+600', tier: 'tier1' },
    { name: 'Bryson DeChambeau', odds: '+900', tier: 'tier1' },
    { name: 'Collin Morikawa', odds: '+1200', tier: 'tier1' },
    { name: 'Xander Schauffele', odds: '+1400', tier: 'tier1' },
    { name: 'Jon Rahm', odds: '+1600', tier: 'tier1' },
  ],
  tier2: [
    { name: 'Ludvig Åberg', odds: '+1800', tier: 'tier2' },
    { name: 'Tommy Fleetwood', odds: '+2000', tier: 'tier2' },
    { name: 'Brooks Koepka', odds: '+2200', tier: 'tier2' },
    { name: 'Shane Lowry', odds: '+2500', tier: 'tier2' },
    { name: 'Tony Finau', odds: '+2800', tier: 'tier2' },
    { name: 'Hideki Matsuyama', odds: '+3000', tier: 'tier2' },
    { name: 'Justin Thomas', odds: '+3200', tier: 'tier2' },
    { name: 'Viktor Hovland', odds: '+3500', tier: 'tier2' },
  ],
  tier3: [
    { name: 'Akshay Bhatia', odds: '+4000', tier: 'tier3' },
    { name: 'Russell Henley', odds: '+4500', tier: 'tier3' },
    { name: 'Min Woo Lee', odds: '+5000', tier: 'tier3' },
    { name: 'Matt Fitzpatrick', odds: '+5500', tier: 'tier3' },
    { name: 'Adam Scott', odds: '+6000', tier: 'tier3' },
    { name: 'Corey Conners', odds: '+6500', tier: 'tier3' },
    { name: 'Sungjae Im', odds: '+7000', tier: 'tier3' },
    { name: 'Harris English', odds: '+8000', tier: 'tier3' },
    { name: 'Phil Mickelson', odds: '+10000', tier: 'tier3' },
  ],
};
